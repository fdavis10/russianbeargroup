...
export const translations: Record<Language, TranslationContent> = {
  ru: {
    ...
    advantages: [
      ...
      "Помощь в получении бесплатного медицинского лечения и страховых выплат в случае ранения ($8 000–$32 000)",
  ...
  en: {
    ...
    advantages: [
      "Salary from 210,000 rubles ($3,000 — depending on the exchange rate at signing)",
      "Full provision of modern tactical equipment",
      "Signing bonus of 1,050,000 rubles ($15,000 — depending on the exchange rate at signing)",
      ...
      "Assistance with free medical treatment and insurance payments in case of injury ($8,000–$32,000)",

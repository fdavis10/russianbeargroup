        ...
        return Response(
            {
                ...
                "hero": {
                    "headline": "Набор граждан со всего мира на службу по контракту — полное сопровождение от заявки до прибытия",
                    "subheadline": "Работаем напрямую с Минобороны РФ. Юридическое оформление, документы, перелёт и сопровождение на каждом этапе — для граждан любой страны.",
                    "cta": "Узнать подробнее",
                },
                "requirements": [
                    {"label": "Возраст", "value": "18–45 лет"},
                    {"label": "Гражданство", "value": "Любая страна мира"},
